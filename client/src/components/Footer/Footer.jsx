        ...
        <div className="grid grid-cols-1 text-sm gap-x-24 gap-y-8 sm:grid-cols-3 md:justify-items-center">
          <div className="space-y-3 py-2">
            ...
            <ul className="space-y-1  ">
              ...
              <li>
                <Link rel="noopener noreferrer" to="/autoridades">
                  Autoridades
                </Link>
              </li>
              <li>
                <Link rel="noopener noreferrer" to="/documentos">
                  Documentos
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3 py-2">
            ...
            <div>
              ...
              <a
                rel="noopener noreferrer"
                href="https://www.instagram.com/educacionfisica.tecnica7"
                title="Instagram"
                className="flex items-center p-1"
                target="_blank"
              >
