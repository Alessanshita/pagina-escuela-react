...
export function HomeIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="bi bi-house-door-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function PublicationIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="bi bi-chat-left-text-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function InstitutionIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="bi bi-building-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function BookIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="bi bi-book-half icon-item"
      viewBox="0 0 16 16"
    >
...
export function QuestionIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="bi bi-question-circle-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function BriefcaseIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="bi bi-briefcase-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function PdfIcon() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-filetype-pdf icon-item"
      viewBox="0 0 16 16"
    >
      <path
        fillRule="evenodd"
...
export function AuthorityIcon() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-people-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function ComputingIcon() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-file-earmark-code-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function GaoIcon() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-duffle-fill icon-item"
      viewBox="0 0 16 16"
    >
...
export function HistoryIcon() {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className="bi bi-clock-history icon-item"
      viewBox="0 0 16 16"
    >
...
export function RectangleIcon() {
  return (
    <svg className="rectangulo-logo" width="10" height="72">
      <path d="M2.10 0 V72" stroke="#E7F1FA" strokeWidth="5"></path>
    </svg>
  )
}
...
export function DeletePostIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="50"
